...
public class Square extends Shape{
    ...
    public void draw(Graphics2D g) {
            ...
            if (getX1() < getX2() && getY1() < getY2()) {
                g.fillRect(getX1(), getY1(), Math.abs(getX2() - getX1()), Math.abs(getX2() - getX1()));
            } else if (getX1() > getX2() && getY1() > getY2()) {
                g.fillRect(getX2(), getY2(), Math.abs(getX2() - getX1()), Math.abs(getX2() - getX1()));
            } else if (getX1() > getX2() && getY1() < getY2()) {
                g.fillRect(getX2(), getY1(), Math.abs(getX2() - getX1()), Math.abs(getX2() - getX1()));
            } else {
                g.fillRect(getX1(), getY2(), Math.abs(getX2() - getX1()), Math.abs(getX2() - getX1()));
            }
